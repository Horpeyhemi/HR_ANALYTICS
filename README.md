...
## Insight ##
![image alt](https://github.com/Horpeyhemi/HR_ANALYTICS/blob/eae062d5083fefd268cd17fe08fab2fe7e7cc214/Analytic%20Dashboard.png)
 ...
 The IT (Information Technology) department has the highest paying average salary, followed by Finance, this suggest that the company invested well in technical and financial roles than other departments.

 The Sales department has the highest headcount but not the highest average salary.

 The "Need Improvement" under performing band are not entitled to the bonus because they have have a low performance score.
